...
namespace ChatBotClient
{
    public partial class Form1 : Form
    {
        ...
        {
            await webViewmyMsc.EnsureCoreWebView2Async(null);
        }
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            webViewmyMsc.Source = new Uri("https://build.microsoft.com/en-US/sessions?sortBy=relevance&filter=additionalTrack%2FlogicalValue%3EAI&filter=deliveryTypes%2FlogicalValue%3EIn-Person");
