...
using myMscChatGpt.LangChain.Bricks;
    ...
    public class UnitTest1
    {
        ...
        public async Task Replace1()
        {
            ...
            var opt = Options.Create(
                new PlaceholdersInformation { LinkRoot= "https://localhost/mymsc/" });
            ...
            m.Setup(m => m.Ask(It.IsAny<Question>())).ReturnsAsync(new myMscChatGpt.Dtos.Completition.Controllers.AnswerToUser
            {
